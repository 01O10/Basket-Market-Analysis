...
1.  **On the content** : instead of implementing a general Markov Chain based on the total dataset, here we implement one specific Markov chain by user to provide a person-centric solution.

2.  **On the form** : the code we produced here relies on the Tidyverse package and the used of nested/mapping functions.
